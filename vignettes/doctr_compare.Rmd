...
One of `doctr`'s main fuctions is `compare()`, which
compares the profiles of two tables, checking if they can be
considered similar enough. This is very usefull when we're
dealing with the evoloution of a table over time, e.g.
