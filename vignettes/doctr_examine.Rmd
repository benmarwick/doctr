...
```{r}
# Get report of numeric variables
report_num(eda)

# Get report of text variables
report_txt(eda)

# Get report of factor variables
report_fct(eda)
```
...
```{r}
# Get report of numeric variables for compact cars
report_num(eda, group = "compact")

# Get report of text variables for SUVs
report_txt(eda, group = "suv")

# Get report of factor variables for midsize cars
